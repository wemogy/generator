...
class SdkDotnetGenerator extends BaseDotnetTemplateGenerator {
  ...
  public end(): void {
    // Add AutoGenerate Project to Library
    addProjectReferenceToProject.bind(this)(
      this.destinationPath(`${this.answers.targetDirectory}/${this.answers.name}/${this.answers.name}.csproj`),
      this.destinationPath(
        `${this.answers.targetDirectory}/${this.answers.name}.AutoGenerated/${this.answers.name}.AutoGenerated.csproj`
      )
    );
