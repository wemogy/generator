...
import <%= name.pascalCase %>VariationThemeDeclarationType from "./theme/<%= name.pascalCase %>VariationThemeDeclarationType";
...
export {
  ...
  <%= name.pascalCase %>VariationThemeDeclarationType,
